defmodule PhoenixProtoWeb.AuctionLive do
  use PhoenixProtoWeb, :live_view

  @topic "auction"

  def mount(params, session, socket) do
   PhoenixProtoWeb.Endpoint.subscribe(@topic)
  ...
  def handle_event("donate-1", _, socket) do
    ...
    PhoenixProtoWeb.Endpoint.broadcast_from(self(), @topic, "donate_event", raised)
